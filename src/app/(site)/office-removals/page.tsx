          ...
          <div className="grid gap-10 lg:grid-cols-[3fr_2fr] lg:items-start lg:gap-16">
            ...
            >
              <div className="relative aspect-[4/3] w-full">
                <Image
                  src="https://images.unsplash.com/photo-1758691738691-557c09410bf7?auto=format&fit=crop&w=2400&q=82"
            ...
            {phases.map((phase, pi) => (
              ...
              >
                ...
                <div className={`pb-4 border-b ${pi === 2 ? "border-white/15" : "border-black/10"}`}>
                  <p className={`text-[0.6rem] font-bold uppercase tracking-widest ${pi === 2 ? "text-brand-red" : "text-brand-red"}`}>
                    Phase {pi + 1}
                  </p>
                      ...
                      <li key={step.name} className={`relative flex gap-3 ${idx > 0 ? "mt-4 pt-4 border-t " + (pi === 2 ? "border-white/10" : "border-black/8") : ""}`}>
                        ...
                        <div>
                          <div className="flex items-center gap-1.5">
                            ...
                            <span aria-hidden="true" className={pi === 2 ? "text-brand-red/80" : "text-brand-red/70"}>
      ...
      <section id="trust" className="bg-brand-navy py-20">
        <div className="mx-auto max-w-[88rem] px-4">
          ...
          <div className="mt-10 mx-auto max-w-3xl grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div data-reveal data-delay="3" className="rounded-2xl bg-brand-red p-6 text-white">
              <h3 className="text-sm font-bold uppercase tracking-wide">
