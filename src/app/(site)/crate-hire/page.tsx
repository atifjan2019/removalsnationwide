...
export default async function CrateHirePage() {
  ...
  return (
    <>
            ...
            >
              ...
              <div className="bg-brand-grey p-6">
                ...
                <ul className="space-y-2">
                  {crateServiceStandards.map(({ name }) => (
      ...
      <CtaBand
        heading="Get Your Crate Hire Quote"
